...
PromptFile="/data/panjiadong/project/NIPS25/B2-DiffuRL-main/config/prompt/template1_train.json"
RandomPrompt=1
Seed=300
Beta1=1
Beta2=1
...
AccStep=64
LR=0.0001
ModelVersion="/data/panjiadong/model/stable-diffusion-v1-4"
NumStep=20
History_Cnt=8
PosThreshold=0.5
NegThreshold=-0.5
...
do
    ...
    python3 run_sample.py $CUDA_FALGS $TRAIN_FLAGS $SAMPLE_FLAGS $RANDOM_FLAGS $EXP_FLAGS $RUN_FLAGS $LORA_FLAGS $SELECT_FLAGS $RESAMPLE_NUM
